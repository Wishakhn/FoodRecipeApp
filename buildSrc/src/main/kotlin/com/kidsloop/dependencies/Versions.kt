...
object AndroidXVersion {
    ...
    const val LIFE_CYCLE_KTX =  "2.4.0-alpha02"
}

object ComposeVersion {
    const val COMPOSE_UI = "1.2.0"
    const val COMPOSE_COMPILER = "1.3.1"
    const val COMPOSE_UI_TOOLING = "1.2.0"
    const val COMPOSE_FOUNDATION = "1.2.0"
    const val COMPOSE_MATERIAL = "1.2.0"
    const val COMPOSE_MATERIAL_CORE = "1.2.0"
    const val COMPOSE_MATERIAL_EXTENDED = "1.2.0"
    const val COMPOSE_LIVEDATA = "1.2.0"
    ...
    const val COMPOSE_VIEW_MODEL = "1.2.0"
    const val COMPOSE_DIMEN = "1.1.0"
    const val COMPOSE_PERMISSIONS = "0.21.1-beta"
    const val COMPOSE_SPLASH = "1.0.0-beta02"
    const val COMPOSE_DESTINATION = "1.6.23-beta"

}
object AccompanistVersion{
    const val COIL = "2.1.0"
    const val SYSTEM_UI_CONTROL = "0.24.3-alpha"
...
object KotlinVersion {
    const val STANDARD_LIBRARY = "1.7.10"
...
object TestVersion{
    ...
    const val TESTRUNNER_VERSION = "1.1.0"
    const val ESPRESSOCORE_VERSION = "3.2.0"
    const val ESPRESSOINTENTS_VERSION = "3.1.0"
    const val TESTRULES_VERSION = "1.1.0"
...
object PluginVersion{
    const val KOTLIN = KotlinVersion.STANDARD_LIBRARY
    const val BUILD_GRADLE = "7.0.4"
